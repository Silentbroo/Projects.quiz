	...
	while (!doexit)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if ((key[0] && player_y >= 0) &&
				...
				!(player_x>70 && player_x<300 && player_y < 252 && player_y >240) &&//pink wall
				!(player_x>250 && player_x<552 && player_y<100 && player_y>90) &&//blue wall
				!(player_x >170 && player_x<252 && player_y<302 && player_y >292)//green wall
				)
			...
			if ((key[1] && player_y <= 480 - 32) &&
				!(player_x>70 && player_x<300 && player_y >166 && player_y<176) &&//pink wall
				!(player_x>170 && player_x<552 && player_y>16 && player_y<26) &&//blue wall
				!(player_x >170 && player_x<252 && player_y<302 && player_y >292)//green wall
				)
			...
			if ((key[3] && player_x <= 640 - 32) &&
				!(player_x >66 && player_x<76 && player_y >166 && player_y<248)&&//pink wall
				!(player_x >168 && player_x<172 && player_y >50 && player_y<267)//green wall
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			//wall 1
			al_draw_filled_rectangle(250, 300, 200, 100, al_map_rgb(0, 150, 150));
			al_draw_filled_rectangle(100, 200, 300, 250, al_map_rgb(250, 100, 250));
			al_draw_filled_rectangle(400, 100, 199.7, 50, al_map_rgb(0, 100, 250));
			al_draw_filled_rectangle(400, 100, 550, 50, al_map_rgb(100, 100, 250));
